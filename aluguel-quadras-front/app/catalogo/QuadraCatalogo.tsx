...
export default function QuadraCatalogo() {
  const [quadras] = useState([
    ...
    { id: 3, nome: 'Quadra de Basquete', localizacao: 'Bairro Norte', tipo: 'Handebol', precoPorHora: 90, imagem: '/images/quadra3.jpg' },
    { id: 4, nome: 'Quadra de Areia', localizacao: 'Praia Central', tipo: 'Beach Tennis', precoPorHora: 120, imagem: '/images/quadra4.jpg' },
    { id: 5, nome: 'Quadra de Tênis', localizacao: 'Bairro Oeste', tipo: 'Tênis', precoPorHora: 85, imagem: '/images/quadra5.jpg' },
    { id: 6, nome: 'Quadra Aberta', localizacao: 'Bairro Leste', tipo: 'Tênis', precoPorHora: 110, imagem: '/images/quadra6.jpg' },
  ]);
